...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> {{ trans('labels.EditTestimonials') }} <small>{{ trans('labels.EditTestimonials') }}...</small> </h1>
    <ol class="breadcrumb">
       <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
      <li><a href="{{ URL::to('admin/news')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.ListingAllTestimonials') }}</a></li>
      <li class="active">{{ trans('labels.EditTestimonials') }}</li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">{{ trans('labels.EditTestimonials') }} </h3>
          </div>
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                          ...
                          @endif
                            ...
                            {!! Form::open(array('url' =>'admin/updatetestimonial', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                               {!! Form::hidden('id',  $result['description'][1]['testimonial_id'], array('class'=>'form-control', 'id'=>'id')) !!}

                            	  @foreach($result['description'] as $description_data)         

                               
                                <div class="form-group">
                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.TitleTestimonials') }} ({{ $description_data['language_name'] }})</label>
                                    <div class="col-sm-10 col-md-4">
                                        ...
                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.TitleTestimonials') }} ({{ $description_data['language_name'] }})</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-8">
                                        <textarea id="editor<?=$description_data['languages_id']?>" name="description_<?=$description_data['languages_id']?>" class="form-control"  rows="10" cols="80">{{ stripslashes($description_data['description']) }}</textarea>
                              ...
                              @endforeach
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    {!! Form::file('image', array('id'=>'news_image')) !!}<br>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                      <input type="text" class="form-control" value="{{$description_data['slug']}}" name="slug">
                                      <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.IsFeatureText') }}</span>
                                  </div>
                                </div>
