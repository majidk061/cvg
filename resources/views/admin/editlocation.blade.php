                         ...
                         <div class="box-body">
                          ...
                          @endif
                            ...
                            {!! Form::open(array('url' =>'admin/updatelocation', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                ...
                                {!! Form::hidden('id',  $result['description']->location_id, array('class'=>'form-control', 'id'=>'id')) !!}
                                <div class="form-group">
                                      <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.TitleAddress') }} </label>
                                      <div class="col-sm-10 col-md-4">
                                          <input type="text" name="address" value="{{$result['description']->full_address}}" class="form-control field-validate">
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-sm-10 col-md-4">
                                          <input type="text" name="slug" value="{{$result['description']->slug}}" class="form-control field-validate">
                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-sm-10 col-md-4">
                                          <input type="text" name="lat" value="{{$result['description']->lat}}" class="form-control field-validate">
                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-sm-10 col-md-4">
                                          <input type="text" name="lng" value="{{$result['description']->lng}}" class="form-control field-validate">
                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
