  ...
  <div id="home" class="slider-area">
    <div class="bend niceties preview-2">
      <div id="ensign-nivoslider" class="slides">
        ...
        $i = 1;
        @endphp
        @foreach($result["slides"] as $slides)
        <img src="{{$slides->image}}" alt="" title="#slider-direction-{{$i}}" />
         @php
        $i = $i+1;
        @endphp
        @endforeach
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                ...
                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                  <h1 class="title2" style="color: #fff;">{{$slides->title}}</h1>
                </div>
                <!-- layer 3 -->
    ...
    <div class="reviews-area hidden-xs">
      <div class="work-us">
        <div class="work-left-text">
          <a href="#">
            <img src="{{asset('public/assets/img/Children-Impacting life.webp')}}" alt="">
          </a>
        </div>
        <div class="work-right-text text-center">
          <h2><?=$result['frenchise_pages'][0]->name?></h2>
           <h6 style="color:#fff;">{!!str_limit($result['frenchise_pages'][0]->description,100,'...')!!}</h6>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-md-5 order-1 order-md-2" data-aos="fade-left">
            <img src="{{asset('public/assets/img/our-company.jpg')}}" class="img-fluid" alt="">
          </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="testimonial-content text-center">
                ...
                <div class="owl-carousel testimonial-carousel">
                  @foreach($result["testimonial"] as $testimonial)
                    <div class="single-testi">
                      <div class="testi-text">
                       {!! $testimonial->project_description !!}
                        <h6>{{$testimonial->project_name}}</h6>
                      </div>
                    </div>
                  @endforeach
                </div>
