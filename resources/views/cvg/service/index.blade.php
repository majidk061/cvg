...
Mapping, Conceptual, Preconstruction, Construction &amp; Control, and Closing &amp; Maintenance.
        ...
        <div class="row">
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-right">
            <div class="card">
              <div class="card-img">
                <img src="{{asset('public/assets/img/services-1.jpg')}}" alt="...">
              </div>
              <div class="card-body">
...
before traditional construction services begin.</p>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-left">
            <div class="card">
              <div class="card-img">
                <img src="{{asset('public/assets/img/services-2.jpg')}}" alt="...">
              </div>
              <div class="card-body">
...
budget, timeline, risk, permitting, value engineering, IPDs, and bidding through the start of construction.</p>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-right">
            <div class="card">
              <div class="card-img">
                <img src="{{asset('public/assets/img/services-3.jpg')}}" alt="...">
              </div>
              <div class="card-body">
...
communication, process controls, and execution to Owner satisfaction during construction and closing.</p>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-left">
            <div class="card">
              <div class="card-img">
                <img src="{{asset('public/assets/img/services-4.jpg')}}" alt="...">
              </div>
              <div class="card-body">
