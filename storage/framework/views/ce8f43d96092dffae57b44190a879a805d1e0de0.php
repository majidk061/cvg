        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="box-tools pull-right">
            	<a href="<?php echo e(URL::to('admin/addwebpage')); ?>" type="button" class="btn btn-block btn-primary"><?php echo e(trans('labels.AddPage')); ?></a>
            </div>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
                   ...
                   <?php if(count($result["pages"])>0): ?>
                    <?php $__currentLoopData = $result["pages"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('labels.Edit')); ?>" href="editwebpage/<?php echo e($data->page_id); ?>" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
