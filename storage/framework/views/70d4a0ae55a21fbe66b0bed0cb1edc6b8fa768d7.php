  ...
  <div id="home" class="slider-area">
    <div class="bend niceties preview-2">
      <div id="ensign-nivoslider" class="slides">
        <img src="<?php echo e(asset('public/new/assets/img/slider/slider1.jpg')); ?>" alt="" title="#slider-direction-1" />
        <img src="<?php echo e(asset('public/new/assets/img/slider/slider2.jpg')); ?>" alt="" title="#slider-direction-2" />
        <img src="<?php echo e(asset('public/new/assets/img/slider/slider3.jpg')); ?>" alt="" title="#slider-direction-3" />
      </div>
    ...
    <div class="reviews-area hidden-xs">
      <div class="work-us">
        <div class="work-left-text">
          <a href="#">
            <img src="<?php echo e(asset('public/new/assets/img/about/2.jpg')); ?>" alt="">
          </a>
        </div>
        <div class="work-right-text text-center">
          <h2><?=$result['frenchise_pages'][0]->name?></h2>
           <h6><?php echo str_limit($result['frenchise_pages'][0]->description,100,'...'); ?></h6>
