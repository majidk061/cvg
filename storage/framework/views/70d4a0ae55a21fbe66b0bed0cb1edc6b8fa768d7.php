            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                ...
                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                  <a class="ready-btn right-btn page-scroll" href="<?php echo e(URL::to('services')); ?>">See Services</a>
                  <a class="ready-btn page-scroll" href="<?php echo e(URL::to('our-company')); ?>">Learn More</a>
                </div>
              </div>
            </div>
          </div>
