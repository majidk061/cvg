...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1><?php echo e(trans('labels.EditMainCategories')); ?>  <small><?php echo e(trans('labels.EditMainCategories')); ?>...</small> </h1>
    <ol class="breadcrumb">
       <li><a href="<?php echo e(URL::to('admin/dashboard/this_month')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(trans('labels.breadcrumb_dashboard')); ?></a></li>
      <li><a href="<?php echo e(URL::to('admin/categories')); ?>"><i class="fa fa-bars"></i> <?php echo e(trans('labels.ListAllCategories')); ?></a></li>
      <li class="active"><?php echo e(trans('labels.EditMainCategories')); ?></li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo e(trans('labels.EditMainCategories')); ?> </h3>
          </div>
                    ...
                    <br>                       
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            <?php echo Form::open(array('url' =>'admin/updatecategory', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                                ...
                                <div class="form-group">
                                  ...
                                  <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;"><?php echo e(trans('labels.CategoryIconText')); ?></span><br>
                              ...
                              <div class="box-footer text-center">
                                ...
                                <a href="<?php echo e(URL::to('admin/categories')); ?>" type="button" class="btn btn-default"><?php echo e(trans('labels.back')); ?></a>
                              </div>
                              <!-- /.box-footer -->
                            <?php echo Form::close(); ?>
