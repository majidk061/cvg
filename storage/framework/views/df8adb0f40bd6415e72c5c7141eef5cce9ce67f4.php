      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><strong><?php echo e(trans('labels.Type')); ?>:</strong> <?php echo e($result['adminType'][0]->admin_type_name); ?> </h3>
          </div>
              ...
              <div class="col-xs-12">
              		<div class="box box-info">
                        ...
                        <?php endif; ?>
                            ...
                            <?php echo Form::hidden('admin_type_id',  $result['admin_type_id'], array('class'=>'form-control', 'id'=>'admin_type_id')); ?>                 	
                            ...
                            <div class="form-group">
                           		<label class="col-sm-2 col-md-3 control-label" style=""><?php echo e(trans('labels.manage '.$data['name'])); ?></label>
                            ...
                            <div class="box-footer text-center">
                            	<button type="submit" class="btn btn-primary"><?php echo e(trans('labels.Add Roles')); ?> </button>
