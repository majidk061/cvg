...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> <?php echo e(trans('labels.EditSubCategories')); ?> <small><?php echo e(trans('labels.EditSubCategories')); ?>...</small> </h1>
    <ol class="breadcrumb">
      ...
      <li class="active"><?php echo e(trans('labels.EditSubCategories')); ?></li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo e(trans('labels.EditSubCategories')); ?> </h3>
          </div>
              		...
              		<div class="box box-info">
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            <?php echo Form::open(array('url' =>'admin/updatesubcategory', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                      <select class="form-control" name="parent_id">
                                         <?php $__currentLoopData = $result['categories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categories): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <option 
                                          <?php if($categories->mainId == $result['editSubCategory'][0]->parent_id): ?>
                                          	selected
                                          <?php endif; ?> 
                                           value="<?php echo e($categories->mainId); ?>"><?php echo e($categories->mainName); ?></option>
