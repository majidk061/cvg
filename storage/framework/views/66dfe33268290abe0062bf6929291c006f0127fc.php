...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> <?php echo e(trans('labels.AddService')); ?> <small><?php echo e(trans('labels.AddService')); ?> ...</small> </h1>
    <ol class="breadcrumb">
      ...
      <li class="active"><?php echo e(trans('labels.AddService')); ?> </li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo e(trans('labels.AddService')); ?>  </h3>
          </div>
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                          ...
                          <?php endif; ?>
                            ...
                            <?php echo Form::open(array('url' =>'admin/addservice', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                              ...
                              <?php $__currentLoopData = $result['languages']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $languages): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-group">
                                      <label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.TitleService')); ?> (<?php echo e($languages->name); ?>) </label>
                                      <div class="col-sm-10 col-md-4">
                                      		<input type="text" name="news_name_<?=$languages->languages_id?>" class="form-control field-validate">
                                     		<span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                     		<?php echo e(trans('labels.TitleService')); ?> (<?php echo e($languages->name); ?>)</span>
                              ...
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    ...
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                    <?php echo e(trans('labels.UploadImageforNews')); ?> *image size must be 540*360</span>
                                    <br>
                                  </div>
                                </div>
                              <!-- /.box-body -->
