        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="box-tools pull-right">
            	<a href="<?php echo e(URL::to('admin/addmanufacturer')); ?>" type="button" class="btn btn-block btn-primary"><?php echo e(trans('labels.AddNewManufacturer')); ?></a>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-xs-12">
                  ...
                  <?php if(count($manufacturers)>0): ?>
                    <?php $__currentLoopData = $manufacturers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$manufacturer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><img src="<?php echo e(asset('').'/'.$manufacturer->image); ?>" alt="" width=" 100px"></td>
                            <td>
                            ...
                            <td>
                            	<a data-toggle="tooltip" data-placement="bottom" title="Edit" href="editmanufacturer/<?php echo e($manufacturer->id); ?>" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                                <a id="manufacturerFrom" manufacturers_id='<?php echo e($manufacturer->id); ?>' data-toggle="tooltip" data-placement="bottom" title="Delete" href="#" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        </tr>
                ...
                <div class="col-xs-12 text-right">
                	<?php echo e($manufacturers->links('vendor.pagination.default')); ?>
