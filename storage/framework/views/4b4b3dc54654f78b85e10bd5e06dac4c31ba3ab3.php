                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                          ...
                          <?php endif; ?>
                            ...
                            <?php echo Form::open(array('url' =>'admin/updateservice', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                                ...
                                <?php echo Form::hidden('id_'.$description_data['languages_id'],  $description_data['service_id'], array('class'=>'form-control', 'id'=>'id'.$description_data['languages_id'])); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        <input type="text" name="news_name_<?=$description_data['languages_id']?>" class="form-control field-validate" value="<?php echo e($description_data['service_name']); ?>">
                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;"><?php echo e(trans('labels.TitleService')); ?> (<?php echo e($description_data['language_name']); ?>)</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-8">
                                        <textarea id="editor<?=$description_data['languages_id']?>" name="news_description_<?=$description_data['languages_id']?>" class="form-control"  rows="10" cols="80"><?php echo e(stripslashes($description_data['service_description'])); ?></textarea>
                              ...
                              <div class="box-footer text-center">
                                ...
                                <a href="<?php echo e(URL::to('admin/service')); ?>" type="button" class="btn btn-default"><?php echo e(trans('labels.back')); ?></a>
                              </div>
