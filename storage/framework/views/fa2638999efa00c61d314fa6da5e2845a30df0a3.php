...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> <?php echo e(trans('labels.AddLocation')); ?> <small><?php echo e(trans('labels.AddLocation')); ?> ...</small> </h1>
    <ol class="breadcrumb">
       <li><a href="#"><i class="fa fa-dashboard"></i> <?php echo e(trans('labels.breadcrumb_dashboard')); ?></a></li>
      <li><a href="<?php echo e(URL::to('admin/news')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(trans('labels.ListingAllLocation')); ?></a></li>
      <li class="active"><?php echo e(trans('labels.AddLocation')); ?> </li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo e(trans('labels.AddLocation')); ?>  </h3>
          </div>
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                          ...
                          <?php endif; ?>
                            ...
                            <?php echo Form::open(array('url' =>'admin/addlocation', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                              ...
                              <div class="box-footer text-center">
                                <button type="submit" class="btn btn-primary"><?php echo e(trans('labels.AddLocation')); ?> </button>
